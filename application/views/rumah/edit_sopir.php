          ...
          <div class="box-body">
            ...
            <?php
                $name = array(
                 ...
                 echo form_open('rumah/editSopir/'.$sopir->idsopir,$name);
            ?>

              <div class="form-group">
                <label for="kategori" class="col-sm-3 control-label">Nama Sopir</label>
                <div class="col-sm-9">
                  <input type="text" id="namasopir" value="<?php echo $sopir->namasopir;?>" name="namasopir" class="form-control" placeholder="Nama Sopir">
                  <?php echo form_error('namasopir');?>
                </div>
              </div>
              <div class="form-group">
                <label for="kategori" class="col-sm-3 control-label">No telepon</label>
                <div class="col-sm-9">
                  <input type="text" id="phone"  name="phone" value="<?php echo $sopir->phone;?>" class="form-control" placeholder="No telepon">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" id="namainstansi" name="namainstansi" value="<?php echo $sopir->namainstansi;?>" class="form-control" placeholder="Nama Instansi">
                  <?php echo form_error('namainstansi');?>
                </div>
              </div>
              <div class="form-group">
                <label for="kategori" class="col-sm-3 control-label">Nomor Plat</label>
                <div class="col-sm-9">
                  <input type="text" id="platnomor" name="platnomor" value="<?php echo $sopir->platnomor;?>" class="form-control" placeholder="Nama Instansi">
                  <?php echo form_error('namainstansi');?>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" id="password" name="password" value="<?php echo $sopir->password;?>" class="form-control" placeholder="password">
