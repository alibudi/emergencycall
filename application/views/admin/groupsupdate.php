    ...
    <div class="col-md-12">
      <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Update Groups</h3>
        ...
        ?>
              ...
              <div class="form-group">
                            <label for="name">Nama Groups</label>
                            <input type="text" name="name" 
                            value="<?php echo $u->name ?>" class="form-control" required oninvalid="setCustomValidity('Nama Groups harus di Isi !')"
             ...
             <div class="form-group">
                            ...
                            value="<?php echo $u->description ?>" class="form-control" required oninvalid="setCustomValidity('Deskripsi Harus di Isi !')"
