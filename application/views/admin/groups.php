<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active"><a href="<?php echo base_url('admin/groups');?>"><i class="fa fa-users"></i> <span>Kelola Groups</span> <span class="label label-warning" id="darurat"></span></a></li>
    ...
    <div class="col-md-12">
      <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Kelola groups</h3>
          ...
          <div class="box-body">
            ...
            <a href="<?php echo base_url('admin/groupsadd');?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Groups</a><br /><br />
                  ...
                  <?php 
                    ...
                    <tr>
                          ...
                          <td style="text-align: center;">
                            <a class='btn btn-info btn-xs' href="<?php echo base_url('admin/groupsupdate/'.$u->id); ?>" class=""> <i class="glyphicon glyphicon-edit"></i> </a> &nbsp;&nbsp;
                            <a class='btn btn-danger btn-xs' href="#" onclick="functionDelete('<?php echo base_url('admin/groupsdelete/'.$u->id); ?>')" class=""><i class="glyphicon glyphicon-trash"></i> </a>    
                          </td>
                    </tr>
...
<script type="text/javascript">
  function functionDelete(url){
    swal({
      ...
      text: "Anda akan menghapus groups!",
      type: 'warning',
      ...
      buttonsStyling: false
        ...
        swal("Terhapus!", "Anda telah mengapus groups", "success");
        window.location = url;
