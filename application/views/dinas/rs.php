...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
     Akun Member
      <small>Akun Member Rumah Sakit</small>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <a href="<?php echo base_url('dinas/addRs');?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Akun Member</a><br /><br />
