<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active"><a href="<?php echo base_url('dinas/profil');?>"><i class="fa fa-user"></i> <span>Profile</span></a></li>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Profile
      <small>Profile Dinkes</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url('dinas/profil');?>"><i class="fa fa-user"></i>Profile</a></li>
